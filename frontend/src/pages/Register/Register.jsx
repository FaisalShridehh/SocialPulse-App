    ...
    <div className="register w-screen h-screen bg-[#f0f2f5] flex items-center justify-center ">
      <div className="register-wrapper w-3/4 h-3/4  flex flex-col md:flex-row gap-2 md:gap-1">
        ...
        <div className="register-right flex-1 flex flex-col justify-center">
          <div className="register-box h-[450px] p-5 bg-white rounded-[10px] flex flex-col justify-between">
            {/* <!--Email input--> */}
            ...
            <button className="register-register-button h-[60px] rounded-[10px] border-none bg-[#42b72a] text-white text-lg md:text-xl font-medium cursor-pointer  md:w-1/2 md:p-1 px-2 self-center">
